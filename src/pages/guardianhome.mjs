...
export function guardianHomePage(site) {
  ...
  <style>
    ...
    .ah-panel { padding: 24px; border-radius: 16px; background: var(--white); box-shadow: 0 12px 34px rgba(var(--black-rgb),0.08); }
    ...
    .ah-message { padding: 14px 16px; border-radius: 10px; background: rgba(var(--live-red-rgb),0.12); }
    ...
    .ah-race-card { padding: 18px; border: 1px solid rgba(var(--black-rgb),0.12); border-radius: 14px; }
    .ah-race-card h3 { margin: 0 0 4px; font-size: 1.05rem; }
    .ah-race-meta { font-size: 0.82rem; opacity: 0.7; margin-bottom: 12px; }
    .ah-athlete-tag { display: inline-flex; padding: 4px 10px; border-radius: 999px; background: var(--black); color: var(--white); font-size: 0.74rem; font-weight: 800; text-transform: uppercase; letter-spacing: 0.03em; margin-bottom: 8px; }
    ...
    .ah-hero-value { font-variant-numeric: tabular-nums; font-weight: 800; font-size: 2.1rem; line-height: 1; color: var(--black); }
    .ah-hero-pending .ah-hero-value { color: rgba(var(--black-rgb),0.35); }
    .ah-hero-label { font-size: 0.85rem; opacity: 0.7; }

    .ah-goal-row { display: flex; flex-wrap: wrap; gap: 10px; margin-bottom: 4px; }
    .ah-badge { display: inline-flex; padding: 5px 10px; border-radius: 999px; background: rgba(var(--green-rgb),0.14); font-size: 0.78rem; font-weight: 800; }

    .ah-tag { display: inline-flex; padding: 4px 11px; border-radius: 999px; font-size: 0.8rem; font-weight: 800; }
    .ah-tag-ahead { background: rgba(var(--green-rgb),0.18); }
    .ah-tag-on_pace { background: rgba(59, 130, 246, 0.18); }
    .ah-tag-at_risk, .ah-tag-missed { background: rgba(107, 114, 128, 0.18); }
    .ah-tag-dns, .ah-tag-dnf { background: rgba(var(--live-red-rgb),0.14); }
    ...
    .ah-checkpoint-row { display: flex; flex-wrap: wrap; justify-content: space-between; gap: 4px 12px; padding: 8px 0; border-bottom: 1px solid rgba(var(--black-rgb),0.08); font-size: 0.86rem; }
    ...
    .ah-empty { padding: 24px; text-align: center; border-radius: 12px; background: rgba(var(--black-rgb),0.05); }
    ...
    .ah-live-dot { display: inline-block; width: 8px; height: 8px; border-radius: 999px; background: var(--live-red); animation: ah-live-pulse 1.6s ease-in-out infinite; }
