...
const styles = `
    ...
    .writer-article-story-link { padding: 12px 16px; border-radius: 9px; background: rgba(var(--green-rgb),.12); font-weight: 700; }
`;
...
export function writerPortalArticlePage(site) {
  ...
  <section class="section section-paper">
    ...
    <div class="container writer-article-shell" data-writer-article-root hidden>
      ...
      <p class="writer-article-story-link" data-writer-article-story-link hidden></p>
