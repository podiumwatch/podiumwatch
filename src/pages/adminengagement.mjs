...
export function adminEngagementPage(site) {
  const content = `${pageHero({
    ...
    description:
      "Control team followers, email alerts, analytics, sponsor placements, delivery testing, and audience growth from one secure dashboard."
  })}
  ...
  <script src="/scripts/admin-engagement.js" defer></script>`;
