...
await writePage("/team-of-the-week/", teamOfTheWeekPage(site));
  ...
  const privateSitemapPrefixes = ["/admin/", "/team-login/", "/team-dashboard/", "/team-editor/", "/team-schedule/", "/team-roster/", "/team-content/", "/team-insights/", "/race-command-center/", "/team-home/", "/team-meet-center/", "/follow/"];
