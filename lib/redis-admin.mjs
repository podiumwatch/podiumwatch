...
// Athlete of the Week 2026-09-21), to stop vote-spam from writing one
// Postgres row per vote (the root cause of the real Supabase Disk IO
// Budget outage, 2026-08-31 -- see docs/DECISIONS.md and
// award_vote_redis.mjs's own header).
//
