...
// The actual field projection lives in lib/race_viewer_service.mjs,
// shared with the guardian tier (Team Workspace Phase Three) so the two
// never silently drift apart -- it also fixes a previously-over-broad
// select("*") here that exposed internal columns (device_id,
